...
public class EquipoMovil {
    ...
    private EstadoEquipoMovil estado;

    private Cliente cliente;

    public EquipoMovil() {
        this.estado = EstadoEquipoMovil.REGISTRADO;
    }

    public EquipoMovil(int id, String marca, String modelo, String imei,
            String tipo, String descripcionDanio,
            EstadoEquipoMovil estado, Cliente cliente) {
        this.id = id;
        this.marca = marca;
        this.modelo = modelo;
        this.imei = imei;
    ...
    public EstadoEquipoMovil getEstado() {
        return estado;
    }

    public void setEstado(EstadoEquipoMovil estado) {
        this.estado = estado;
    }
